    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white border border-gray-200 rounded-2xl shadow-xl p-8 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="admin@fuelbharat.com"
              required
            />
          </div>
        ...
        <div className="mt-6 text-center space-y-2">
          <Link to="/signup" className="text-gray-600 hover:text-gray-900 text-sm transition-colors block">
            New to Fuely? <span className="text-orange-500 font-medium">Register your station</span>
          </Link>
